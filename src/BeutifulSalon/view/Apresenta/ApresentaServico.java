 ...
 * @author Mateus
 */
public class ApresentaServico extends javax.swing.JPanel {

    private final ServicoTableModel modelo = new ServicoTableModel ();
    ...
    private void initComponents() {
        ...
        jTableServicos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Preço", "Tempo Gasto", "Quantidade"
            }
        ) {
        ...
        jTableServicos.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jTableServicos.setGridColor(new java.awt.Color(243, 244, 245));
        jTableServicos.setRowHeight(22);
        jTableServicos.setSelectionMode(javax.swing.ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
        jTableServicos.setShowGrid(true);
        ...
        jLabel2.setText("Confira os serviços cadastrados do seu salão!");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/icons8-servicos-48.png"))); // NOI18N
